...
//! opt-in [`audit`] log, the opt-in [`push`] wake policy (ADR-0023: stored
//! registrations and the pure wake decision; delivery I/O is a later slice),
//! and the [`server`] that binds the WebSocket listener and drives the router
//! (#231).
